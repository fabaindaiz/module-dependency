...
from dependency.library.patterns.state import StateHolder as StateHolder
from typing import Any, Generic, TypeVar

STATE = TypeVar('STATE')

class StateComponent(Component, Generic[STATE], metaclass=abc.ABCMeta):
...
class StateMixin(Generic[STATE], metaclass=abc.ABCMeta):
