...
def generate_graph(plugins: Iterable[type[ContainerMixin]], output: str = 'build/output', ignore_modules: Collection[str] = ...) -> None:
    ...
    """
def process_container(graph: Graph, container: ContainerInjection, ignore_modules: Collection[str] = ...) -> Cluster: ...
def process_provider(graph: Graph, provider: ProviderInjection, ignore_modules: Collection[str] = ...) -> Node: ...
