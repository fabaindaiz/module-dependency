...
class InjectionResolver:
    ...
    def resolve_dependencies(self, modules: Iterable[type[ContainerMixin]], strategy: ResolutionStrategy | None = None) -> list[ProviderInjection]: ...
    ...
    def resolve_injectables(self, modules: Iterable[type[ContainerMixin]], extra: Iterable[ProviderInjection] = ()) -> set[ProviderInjection]:
        ...
        """
    def resolve_providers(self, providers: set[ProviderInjection], strategy: ResolutionStrategy | None = None) -> list[ProviderInjection]: ...
