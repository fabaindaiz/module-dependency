...
def instance(component: type[Component], imports: Iterable[type[ProviderMixin]] = [], products: Iterable[type[Product]] = [], provider: type[providers.Provider[Any]] = ..., bootstrap: bool = False) -> Callable[[type[T]], type[T]]:
