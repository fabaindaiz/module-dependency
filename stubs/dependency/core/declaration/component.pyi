...
def component(module: type[Module] | None = None, imports: Iterable[type[ProviderMixin]] = (), optional: Iterable[type[ProviderMixin]] = (), strict_resolution: bool = True, provider: InstanceOrClass[providers.Provider[Any]] | None = None, bootstrap: bool = False) -> Callable[[type[COMPONENT]], type[COMPONENT]]:
