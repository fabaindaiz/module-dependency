from dependency.core.agrupation import Entrypoint as Entrypoint, FallbackInternal as FallbackInternal, Module as Module, Plugin as Plugin, PluginMeta as PluginMeta, module as module
...
__all__ = ['LazyProvide', 'LazyProvider', 'LazyClosing', 'Container', 'Registry', 'InjectionResolver', 'ResolutionConfig', 'ResolutionStrategy', 'DependencyError', 'CancelInitialization', 'FallbackInternal', 'Entrypoint', 'Module', 'module', 'Plugin', 'PluginMeta', 'Component', 'component', 'Product', 'product', 'instance', 'providers']
